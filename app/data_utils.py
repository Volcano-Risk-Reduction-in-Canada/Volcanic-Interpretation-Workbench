...
from dash.dcc import Dropdown, Input, RadioItems, Slider, Checklist
...
def plot_annotation_tab(site, host):
    text_styling = {
        'color' : 'black',
        'margin' : '0px 5px'
    }
    ...
    return html.Div(
        style={
           ...
           'margin': '20px 10px',
            ...
            # 'boxShadow': '0 4px 8px rgba(0, 0, 0, 0.1)'  # Optional: Add shadow effect 
        },
        children=[
            html.Div(
                style={
                ...
                children=[
                    html.Div(
                        [
                            html.Div(
                                [
                                    html.P('User', style=text_styling),
                                    Dropdown(
                                        id='user-name',
                            ...
                            html.Div(
                                [
                                    html.P('End Date Observed', style=text_styling),
                                    Input(
                                        id='my-input',
                                        type='text',
                        ...
                        [
                            html.Div(
                                [
                                    html.Div(
                                        [
                                            html.P('Coherence Present', style=text_styling),
                                            RadioItems(
                                    ...
                                    html.Div(
                                        [
                                            html.P('Confidence', style=text_styling),
                                            Slider(
                                                id='confidence',
                                    ...
                                    html.Div(
                                        [
                                            html.P('Further Geoscience Interpretation Needed', style=text_styling),
                                            RadioItems(
                            ...
                            html.Div(
                                [
                                    html.P('InSAR Phase Anomalies', style=text_styling),
                                    Checklist(
                                        id='insar-phase-anomalies',
                                        options=[
                                            {'label': 'Magmatic Deformation', 'value': 'Magmatic Deformation'},
                                            {'label': 'Slope Movement', 'value': 'Slope Movement'},
                                            {'label': 'Glacial Movement', 'value': 'Glacial Movement'},
                                            {'label': 'Topographic Phase Error', 'value': 'Topographic Phase Error'},
                                            {'label': 'Atmospheric Phase Error', 'value': 'Atmospheric Phase Error'},
                                            {'label': 'Baseline Phase Error', 'value': 'Baseline Phase Error'},
                    ...
                    html.Div(
                        [
                            html.Div(
                                [
                                    html.P('Additional Comments', style=text_styling),
                                    Input(
                                        id='my-input',
                                        type='text',
                                ...
                                style={**row_element, 'margin-right': '400px'}
                            ),
                            html.Button(
                                'Click Me',  # Button text
                                id='my-button',  # Unique ID for the button
                                style=button_style  # Apply the custom style to the button
                            ),
                        ],
                        style=row_element
                    )
